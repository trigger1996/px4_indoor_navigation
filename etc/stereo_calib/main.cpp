...
int main(int argc, char *argv[]) {
	...
	Size boardSize;									// 横向的角点数目，这个自己看看example数一下就明白为什么是9和6了
	vector<string> imagelist;
	...
	for (int i = 0; i < image_size; i++) {
		string img_name, dir_l, dir_r;

		img_name = to_string(i + 1) + ".jpg";
		dir_l = "./left/"  + img_name;
		dir_r = "./right/" + img_name;

		imagelist.push_back(dir_l);
		imagelist.push_back(dir_r);
	}
